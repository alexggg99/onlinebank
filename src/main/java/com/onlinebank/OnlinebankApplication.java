...
public class OnlinebankApplication implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		primaryTransactionRepo.save(new PrimaryTransaction(new Timestamp(simpleDateFormat.parse("24-11-2017 21:30:02").getTime()), "ok", -230, primaryAccount));
		primaryTransactionRepo.save(new PrimaryTransaction(new Timestamp(simpleDateFormat.parse("02-12-2017 02:01:02").getTime()), "ok", -230, primaryAccount));
