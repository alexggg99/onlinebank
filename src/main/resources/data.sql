...
insert into primary_transaction(id, date, status, amount, available_balance, account_id, description)
values (1, to_date('24-09-2017 22:01:02', 'dd-MM-yyyy hh:mm:ss'), 'ok', 230, 230, 1, 'test desc');
...
insert into primary_transaction(id, date, status, amount, available_balance, account_id, description)
values (5, to_date('11-12-2017 18:45:45', 'dd-MM-yyyy hh:mm:ss'), 'ok', 200, 200, 1, 'test desc 2');
insert into primary_transaction(id, date, status, amount, available_balance, account_id)
